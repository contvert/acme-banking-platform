...
const ORGS: OrgAccount[] = [
  ...
  { org: 'Acme', balance: 4_944_707.08, movement: 86_300_000, action: 'Open Banking' },
...
const columns: Column<OrgAccount>[] = [
  ...
  {
    key: 'action', header: '', numeric: true,
...
export default function PanoramaPage() {
  return (
    <Page
      title="All Accounts"
      actions={[
        { label: 'Set as default view', icon: 'star' },
        { label: 'Download statements', icon: 'arrow-down-to-line', href: '/settings/documents/statements' },
      ]}
    >
      <DataTable
        rows={ORGS}
