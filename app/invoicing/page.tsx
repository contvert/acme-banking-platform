...
export default function InvoicingPage() {
  ...
  return (
    <Page
      ...
      pill="Pro"
      actions={[
        { label: 'Invoice settings', icon: 'gear', href: '/invoicing/invoice-settings' },
        { label: 'Request money', icon: 'envelope-open-dollar', primary: true, href: '/invoicing/create-invoice' },
      ]}
    >
      <StatTiles
        tiles={[
